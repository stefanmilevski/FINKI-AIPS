...
1. Даден е целосниот код на структурата којашто треба да се користи. Дадена е и тест класата SpecialSLLJoin.java, со целосно имплементиран input и output. Потребно е да се менува само во рамки на void specialJoin(SLL<Integer> list1, SLL<Integer> list2) функцијата.
...
public class SpecialSLLJoin<E> {
    ...
    public SLL<E> specialJoin(SLL<E> list1, SLL<E> list2) {
        ...
        while (list1.getFirst() != null && list2.getFirst() !=null){
            int counter1 = 0;
            int counter2 = 0;
            while(counter1 < 2 && list1.getFirst()!=null){
                resultList.insertLast(list1.getFirst().element);
                list1.deleteFirst();
                counter1++;
            }
            while(counter2 < 2 && list2.getFirst()!=null){
                resultList.insertLast(list2.getFirst().element);
                list2.deleteFirst();
                counter2++;
            }
        ...
        if(list1.getFirst() == null){
            resultList.merge(list2);
        }else if(list2.getFirst() == null){
            resultList.merge(list1);
        }
        return resultList;
    }
